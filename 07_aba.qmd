...
Area-based approaches takes lidar metrics and connects them to forest (or other ecosystem) attributes measured on the ground. This classic approach was originally presented by [Nasset 2002](https://doi.org/10.1016/S0034-4257(01)00290-5 "Predicting forest stand characteristics with airborne scanning laser using a practical two-stage procedure and field data - Remote Sensing of Environment 2002").

ABA generally use coregistered plots as samples to build models to estimate field measured attributes across wall-to-wall coverages of lidar `pixel_metrics`.

In doing so we can transform these lidar derived metric rasters into maps of key forest inventory variables such as stem volume, basal area, and stem density.
